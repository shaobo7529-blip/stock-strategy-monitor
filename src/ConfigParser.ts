...
const VALID_STRATEGY_TYPES: StrategyType[] = ['single-day-drop', 'underperform-benchmark', 'rsi2-oversold', 'consecutive-down-days', 'ma-pullback', 'cumulative-rsi2', 'vix-spike', 'extreme-panic', 'hammer-reversal', 'golden-cross', 'donchian-breakout', 'dual-ma-trend'];
